...
public class UserRegistry {
    ...
    /**
     * Deletes all users (used by tests).
     */
    ...
    private synchronized void saveUsersToFile(Vector<User> users) {
        try {
            ...
            log.print(2, "UserRegistry: FileNotFoundException upon writing " + STORE_FILE);
        } catch(IOException e) {
            log.print(2, "UserRegistry: IOException upon writing " + STORE_FILE);
        }
    }
}
