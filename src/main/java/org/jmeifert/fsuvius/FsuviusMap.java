...
public class FsuviusMap {
    ...
    /**
     * This prefix specifies addresses to allow edits from.
     * (ex. "123.123.123" allows 123.123.123.*)
     * Any PUT/POST/DELETE/etc. requests from outside the specified range are rejected.
     * Recommended: "128.153.144"
     */
    public static final String COSI_ADDR_PREFIX = "128.153.144";
